...
export function _ListPublished() {
  // * DEFINITIONS
  ...
  const RenderTable = () => {
    return (
      <ModuleTableLayout
        {...moduleConfig}
        moduleTerm="Published Applicant"
        moduleTermPlural="Published Applicant"
        moduleName="Published Applicants"
        moduleDescription="Manage all published applicants from Applicants."
