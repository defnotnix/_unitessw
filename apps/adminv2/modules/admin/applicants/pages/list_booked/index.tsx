...
export function _ListBooked() {
  ...
  const RenderTable = () => {
    return (
      <ModuleTableLayout
        {...moduleConfig}
        moduleTerm="Booked Applicant"
        moduleTermPlural="Booked Applicant"
        moduleName="Booked Applicants"
        moduleDescription="Manage all Booked applicants from Applicants."
