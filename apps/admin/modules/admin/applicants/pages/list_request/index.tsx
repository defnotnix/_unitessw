...
export function _ListRequest() {
  ...
  const RenderTable = () => {
    return (
      <ModuleTableLayout
        {...moduleConfig}
        moduleTerm="Applicant Request"
        moduleTermPlural="Applicant Requests"
        moduleName="Applicant Requests"
        moduleDescription="Manage all applicant requests from Applicants."
