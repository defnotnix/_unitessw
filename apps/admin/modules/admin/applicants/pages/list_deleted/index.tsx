...
export function _ListDeleted() {
  ...
  const RenderTable = () => {
    return (
      <ModuleTableLayout
        {...moduleConfig}
        moduleTerm="Deleted Applicant"
        moduleTermPlural="Deleted Applicant"
        moduleName="Deleted Applicants"
        moduleDescription="Manage all Deleted applicants from Applicants."
  ...
  return (
    <>
      <RBACCheck showStaff>
        <ListHandler
          endpoint={"/applicant/get/deleted/"}
